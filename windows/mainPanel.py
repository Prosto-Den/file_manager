...
from framework.events import EVT_DISK_CHANGED, DiskChangedEvent
...
class MainPanel(wx.Panel):
    def __init__(self, parent: wx.Window, id: int = wx.ID_ANY, pos: wx.Point = wx.DefaultPosition,
        ...
        # виджеты
        self.__control_panel = ControlPanel(parent=self, size=CONTROL_PANEL_SIZE)
        ...
        self.Bind(event=EVT_DISK_CHANGED, handler=self.__change_file_viewer_disk, source=self.__control_panel)
